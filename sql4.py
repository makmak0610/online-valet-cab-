...
tree = ttk.Treeview(root, columns=('ID', 'Username','Card_number','Expiry_month','Expiry_year','cvv'), show='headings')
tree.heading('ID', text='ID')
tree.heading('Username', text='Username')
tree.heading('Card_number', text='Card_number')
tree.heading('Expiry_month', text='Expiry_month')
tree.heading('Expiry_year', text='Expiry_year')
