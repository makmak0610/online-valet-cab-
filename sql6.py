...
def load_data():
    ...
    cursor.execute("SELECT * FROM earn")
...
tree = ttk.Treeview(root, columns=('ID', 'Username','Date','Ride', 'Earning'), show='headings')
tree.heading('ID', text='ID')
tree.heading('Username', text='Username')
tree.heading('Date', text='Date')
tree.heading('Ride', text='Ride')
tree.heading('Earning', text='Earning')
tree.pack()
